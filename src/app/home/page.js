...
const Homepage = () => {
    const companyStats = [
        ...
        { number: "100M+", label: "Total Pembiayaan" },
        { number: "24/6", label: "Layanan Konsultasi" }
    ];
        ...
        <>
            ...
            <div className="hero min-h-screen relative bg-gradient-to-b from-gray-900 via-gray-800 to-black">
                <div className="absolute inset-0">
                    <Image
                        src={getImagePath('/images/bank.jpg')}
                        alt="Bank background"
                        fill
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto motion-safe:animate-fade-up"
                           style={{ animationDelay: '0.2s' }}>
                            KSPSS BMT Prima Sentosa adalah lembaga keuangan syariah yang bergerak di bidang pembiayaan syariah yang berbasis di Desa Sidokriyo.
                        </p>
                    </div>
                </div>
                            ...
                            <div className="card-body">
                                ...
                                <ul className="space-y-4 text-gray-300">
                                    <li className="flex items-start">
                                        ...
                                        Menjadi lembaga keuangan syariah yang terpercaya dan berkontribusi dalam pembangunan ekonomi masyarakat
                                    </li>
                                </ul>
                            </div>
                        </div>
